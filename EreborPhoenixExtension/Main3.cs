...
//            Instance.Settings = (new Settings().Deserialize(Config.Profile.ProfileName));//"WindowSize"));
...
//            XmlSerializeHelper<Settings> h = new XmlSerializeHelper<Settings>();
//            Instance.Settings = h.Deserialize(Config.Profile.ProfileName + "LOL");
//            //nacist GUI
...
//            new XmlSerializeHelper<Mine>().Save("Mining", Instance.Settings.Mining);
...
//            Instance.Settings.Mining = ss.Deserialize("Mining");
...
//            XmlSerializeHelper<Settings> h = new XmlSerializeHelper<Settings>();
//            h.Save(Config.Profile.ProfileName+"LOL", Settings);
